...
async function configureExpress() {
    ...
    app.use(async function(req, res, next) {
        ...
        //daemoncheck
        if(['deals', 'deal', 'make-deal', 'creators', 'manage-products', 'create-or-buy','buyers', 'simulation', 'teams', 'team', 'market', 'sale', 'order', 'orders', 'sales', 'market-dashboard', 'chat', '/api/chat/rooms', '/api/chat/search', '/api/chat/contacts/online',
            ...
            || req.query.shipped || req.query.page || req.query.mentioned){
            let daemons = [];
            if(req.session.user){
