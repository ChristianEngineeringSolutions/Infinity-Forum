...
async function configureExpress() {
    ...
    app.use(async function(req, res, next) {
        ...
        //daemoncheck
        if(['creators', 'manage-products', 'create-or-buy','buyers', 'simulation', 'teams', 'team', 'market', 'sale', 'order', 'orders', 'sales', 'market-dashboard', 'chat', '/api/chat/rooms', '/api/chat/search', '/api/chat/contacts/online',
